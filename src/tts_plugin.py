...
class TtsPlugin(QObject):
    ...
    def get_voice_engines(self, src_lang):
        ...
        return engine_list + self.network_all_list + self.local_all_list    
        ...
        for plugin_name in os.listdir(self.plugin_dir):
            ...
            if need_network:
                if support_all_language:
                    self.network_all_list.append((plugin_name, plugin_display_name))
                else:
                    self.update_dict(self.network_dict, support_languages, plugin_name, plugin_display_name)
            else:
                if support_all_language:
                    self.local_all_list.append((plugin_name, plugin_display_name))
                else:
                    self.update_dict(self.local_dict, support_languages, plugin_name, plugin_display_name)
    ...
    def update_dict(self, info_dict, languages, plugin_name, plugin_display_name):
